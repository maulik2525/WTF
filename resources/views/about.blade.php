...
<body>
    <main>
        ...
        <section class="hero-section">
            <div class="about_sec">
                <div class="about">
                    <h1 class="about_h1">Our Journey in Style</h1>
                    <p style="color: #000;">Crafting timeless pieces and sustainable fashion for the modern individual since 2015.</p>
                </div>
                <video id="video" src="/imgs/about.mp4" width="100%" loop autoplay muted></video>
            </div>
        </section>
        <!--  -->
        <section class="story">
            <div class="story-section container">
                <div class="story-content">
                    <h2>The Story of [Your Brand]</h2>
                    <p>The Kamani narrative began with a foundational philosophy: a belief that exquisite craftsmanship and ethical sourcing must coexist with the enduring beauty of the garment. Conceived by Clara and Ben within a serene atelier in Amreli, our commitment was established to redefine the pace of modern luxury. We focus on curating durable materials and championing a minimalist design ethos—creating pieces of profound significance that defy fleeting seasonal currents.</p>
                    <p>Each collection serves as a powerful testament to our promise of absolute transparency and our dedication to elevating the craft of local artisans. We meticulously fuse time-honored tailoring methods with innovative, recycled textiles, ensuring that every Kamani garment is not merely an article of clothing, but an authentic statement of conscious, enduring style.</p>
                </div>
                <div class="story-image">
                    <img src="/imgs/family2.jpg" alt="" width="100%" height="50%">
                </div>
            </div>
        </section>
        <!--  -->
                ...
                <div class="container">
                    ...
                    <div class="values-grid">
                        <div class="value-item">
                            ...
                            <h3>Quality First</h3>
                            <p>We use premium, locally-sourced materials designed to last, rejecting fast-fashion cycles.</p>
                        </div>
                        <div class="value-item">
                            <span class="icon">🌿</span>
                            <h3>Sustainability</h3>
                            <p>Committed to a zero-waste policy and ethical production from farm to closet.</p>
                        </div>
                        <div class="value-item">
                            <span class="icon">🤝</span>
                            <h3>Transparency</h3>
                            <p>Full visibility into our supply chain and fair wages for all our talented team members.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="team-section">
            <div class="container">
                <h2 class="team-section_h2">Meet the Visionaries</h2>
                <div class="team-grid">
